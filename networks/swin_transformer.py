...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        # x_windows = window_packing(shifted_x, self.window_size)  # nW*B, window_size, window_size, C
        ...
        # shifted_x = window_unpacking(attn_windows, self.window_size, Hp, Wp)  # B H' W' C
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.patch_embed = PatchEmbed(
            ...
            in_chans=in_chans*num_input_images,
            embed_dim=embed_dim,
